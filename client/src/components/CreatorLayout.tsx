  ...
  if (!loading && !isAuth) {
    return (
      <div className="flex flex-col items-center justify-center py-24 gap-4">
        <p className="text-lg opacity-70">You need to log in to access the Creator area.</p>
        <button
      ...
      <aside className="w-52 shrink-0">
        <div className="bg-white/10 dark:bg-white/5 rounded-xl border border-white/10 p-3 sticky top-24">
          ...
          <nav className="flex flex-col gap-0.5">
            <SideLink to="/creator" end>My Tests</SideLink>
            <SideLink to="/creator/tests/new">New Test</SideLink>
          </nav>
        </div>
      </aside>
